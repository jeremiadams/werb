...
export default function PopularNews(props) {
    ...
    return (
        <div className="popularnews__card">
            <a href={props.url} target="_blank" className="popularnews__card-link">
                <div className="popularnews__image-box" style={styles}>
                </div>
            </a>
            <div className="popularnews__share">
                        <a target="_blank" href={`https://www.facebook.com/sharer/sharer.php?u=${props.url}`}>
                        ...
                        <a target="_blank" href={`https://www.linkedin.com/sharing/share-offsite/?url=${props.url}`}>
                            <span id="popularnews__share-btn" className="popularnews__share-btn"> 
                        ...
                        <a target="_blank" href={`http://twitter.com/share?text=Via Werb&url=${props.url}&hashtags=werbchromeextension,werb`}>
                            <span id="popularnews__share-btn" className="popularnews__share-btn"> 
            ...
            <div className="popularnews__bottom">
                <span id="popularnews__share-btn" className="popularnews__bookmark-btn" style={{cursor: 'auto'}}>
                    <img src={Logo} alt="web 3 logo" className="logo" style={{cursor: 'auto', width: '25px'}}/>
                </span>
            </div>
        </div>
    )
